...
import static org.apache.hadoop.hive.ql.io.arrow.ArrowColumnarBatchSerDe.*;
...
class Serializer {
  private final int MAX_BUFFERED_ROWS = 1000;
  ...
  private void write(FieldVector arrowVector, ColumnVector hiveVector, TypeInfo typeInfo, int size) {
    switch (typeInfo.getCategory()) {
      ...
      case LIST:
        ...
        break;
      case STRUCT:
        writeStruct((StructVector) arrowVector, (StructColumnVector) hiveVector, (StructTypeInfo) typeInfo, size);
        break;
      case UNION:
  ...
  private void writeMap(ListVector arrowVector, MapColumnVector hiveVector, MapTypeInfo typeInfo,
    ...
    for (int rowIndex = 0; rowIndex < size; rowIndex++) {
      if (hiveVector.isNull[rowIndex]) {
        ...
        BitVectorHelper.setBit(validityBuffer, rowIndex);
      }
    }
  }
  ...
  private void writeStruct(StructVector arrowVector, StructColumnVector hiveVector,
