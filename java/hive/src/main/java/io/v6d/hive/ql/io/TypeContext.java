...
public class TypeContext {
    ...
    public static TypeInfo[] computeTargetTypeInfos(StructTypeInfo structTypeInfo, ObjectInspectorUtils.ObjectInspectorCopyOption option) {
        StructObjectInspector rowObjectInspector;
        if (option == ObjectInspectorUtils.ObjectInspectorCopyOption.JAVA) {
            rowObjectInspector = (StructObjectInspector) TypeInfoUtils.getStandardJavaObjectInspectorFromTypeInfo (structTypeInfo);
        } else {
            rowObjectInspector = (StructObjectInspector) TypeInfoUtils.getStandardWritableObjectInspectorFromTypeInfo (structTypeInfo);
        }
