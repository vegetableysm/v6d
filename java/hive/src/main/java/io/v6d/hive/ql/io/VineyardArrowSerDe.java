...
public class VineyardArrowSerDe extends ArrowColumnarBatchSerDe {
    ...
    public void initializeTypeInfo(Configuration configuration, Properties tableProperties) {
        ...
        StructObjectInspector rowObjectInspector = (StructObjectInspector) getStandardJavaObjectInspectorFromTypeInfo(rowTypeInfo);
    ...
    public VineyardRowWritable serialize(Object obj, ObjectInspector objInspector) {
        ...
        ObjectInspectorUtils.copyToStandardObject(standardObjects, obj,
            ((StructObjectInspector) objInspector), ObjectInspectorUtils.ObjectInspectorCopyOption.JAVA);
